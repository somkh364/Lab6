...
print(bm)
```
The the execution time of 10 replications of the brute force algorithm with 16 object have decreased from `r bm$elapsed[2]` to `r bm$elapsed[1]`. Which is a `r (bm$elapsed[2] - bm$elapsed[1]) / (bm$elapsed[2]) * 100` % decrease.
